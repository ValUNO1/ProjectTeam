...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        user = "bkbk"       #must be a valid username for theapplication
        pwd = "Testcase@3"         #must be the password for a valid user
        #open the browser and go to the admin page
        driver = self.driver
        driver.maximize_window()
        driver.get("http://dorcas.pythonanywhere.com/login/")
